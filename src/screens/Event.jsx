...
//     duration: '',
//     date: '',
//     isFree: null, // Use null to represent 'All'
//     status: '',
//   });
...
//       (filters.status ? event.status.toLowerCase() === filters.status.toLowerCase() : true)
//     );
//   });
...
//     e.preventDefault();
//     const newEventWithId = { ...newEvent, id: events.length + 1 }; // Adding an id
...
//         <h2 className="text-3xl font-bold mb-6">{filters.status || 'All'} Events</h2>
...
//                 </label>
//                 <label className="block mb-4">
//                   <span className="text-gray-700 block text-left">Host Name:</span>
//                   <input
//                     type="text"
//                     name="hostname"
...
//                 </label>
//                 <label className="block mb-4">
//                   <span className="text-gray-700 block text-left">Description:</span>
//                   <textarea
//                     name="description"
...
//                 </div>
//                 <label className="block mb-4">
//                   <span className="text-gray-700 block text-left">Address:</span>
//                   <textarea
//                     type="text"
//                     name="address"
...
//               <Link to='/eventdetails' key={event.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
