    ...
    <div className="py-12 bg-gray-100 min-h-screen">
      <div className="container mx-auto px-4">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg mx-auto">
          ...
          <p className="text-gray-600 mb-2"><strong>Contact Details:</strong> {venue.contact}</p>
          <p className="text-gray-600 mb-2"><strong>Address:</strong> {venue.address}</p>
          <p className="text-gray-600 mb-2"><strong>Capacity:</strong> {venue.capacity}</p>
          <p className="text-gray-600 mb-2"><strong>Price:</strong> {venue.cost}</p>
